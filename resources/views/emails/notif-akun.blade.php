...
<body>
    <div style="padding: 10px;">
        ...
        <small style="color: #000;">W-JAR laravel-10 | by Abduloh</small>
        <p style="font-family: `Segoe UI`, Tahoma, Geneva, Verdana, sans-serif; color: #000;">
            Halo {{ $details['nama'] }}, Admin telah menambahkan kamu kedalam aplikasi W-JAR, berikut merupakan informasi akunmu :
        </p>
