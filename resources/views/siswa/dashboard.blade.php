    ...
    <div id="content" class="main-content">
                            ...
                            <div class="w-content">
                                <div class="">
                                    ...
                                    @foreach ($tugas as $t)
                                        ...
                                        @endif
                                    @endforeach
                                    <p class="task-completed"><span>{{ $tugas_tidak_telat }} Tantangan Sukses
                                            Dikerjakan</span></p>
                                    <p class="task-hight-priority"><span>{{ $tugas_telat }} Tantangan</span> Terlambat
                                        Dikerjakan</p>
                                </div>
                            </div>
                        </div>
        ...
        <div class="footer-wrapper">
            <div class="footer-section f-section-1">
                <p class="">Copyright © 2024 <a target="_blank" href="https://www.instagram.com/uniska.kediri_official/"
                        class="text-primary">UNISKA</a></p>
            </div>
