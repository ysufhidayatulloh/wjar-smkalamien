                            ...
                            <div class="col-lg-4 layout-spacing">
                                <div class="widget shadow p-3">
                                    <div class="widget-heading">
                                        <h5>Tantangan Saya</h5>
                                    </div>

                                    {{-- cek apakah dia daftar sebelum tantangan dibuat --}}
                                    @if ($tugas_siswa != null)

                                        {{-- cek apakah tantangannya sudah dikerjakan --}}
                                        @if ($tugas_siswa->date_send === null)

                                            <p>tantangan Belum Dikerjakan. Segera dikerjakan sebelum <?= $tugas->due_date; ?></p>
    ...
    <div class="modal fade" id="kerjakan_tugas" tabindex="-1" role="dialog" aria-labelledby="kerjakan_tugasLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <form action="{{ url("/siswa/tugas/" . $tugas->kode) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="kerjakan_tugasLabel">Tantangan  Tantangan</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            x
                        </button>
                    </div>
